  ...
  <table class="table table-striped table-prod tb1" role="table">
    ...
    <tbody role="rowgroup">
      <tr role="row">
        ...
        <td role="cell">Medias</td>
        <td role="cell">Compresión 50</td>
